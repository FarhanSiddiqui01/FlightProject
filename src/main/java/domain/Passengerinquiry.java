...
public class Passengerinquiry {
    ...
    public Passengerinquiry(String name, String contact, String address, String airline, String flightNumber, LocalDate flightDate, String source, String destination, Double fare) {
        this.name = name;
