...
//            data[row][4] = passengers.get(row).getFlightNumber();
...
//    }
    ...
    public static Passengerinquiry searchpassenger(String contact) {
        PassengerRepository passengerRepository = new PassengerRepository();
        Passengerinquiry pass = passengerRepository.getPassengerForInquiry(contact);
    ...
    public static Boolean FlightEdit(Long id, String flight_number, String src, String des, LocalDate flight_date, Double fare, Long aeroId) {
        FlightRepository flightRepository = new FlightRepository();
        flightRepository.UpdateFlight(id,flight_number,des,src,flight_date,fare,aeroId);
        return true; }
